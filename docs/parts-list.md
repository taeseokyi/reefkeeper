...
| 13 | 세라믹 콘덴서 100nF (104) | 50V 이상 | 3 | 고주파 노이즈 제거 (C1: Arduino, C2: ADS1115, C4: DS18B20) |
| 14 | 전해 콘덴서 10μF | 16V 이상 | 1 | ADS1115 전원 리플 안정화 (C3, C2와 병렬) |
| 15 | 저항 4.7kΩ | 1/4W | 1 | DS18B20 풀업 저항 (A0 → VCC) |
| 16 | 저항 10kΩ | 1/4W | 1 | HC-06 TX 전압분배기 (R4) |
| 17 | 저항 20kΩ | 1/4W | 1 | HC-06 TX 전압분배기 (R5) |
