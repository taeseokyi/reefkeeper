...
> **이 프로젝트의 하드웨어 설계, 소프트웨어, 문서는 어떠한 공식 검증도 거치지 않았습니다.** 측정 정확도, 전기적 안전성, 장기 신뢰성에 대한 보증이 없습니다. 이 프로젝트를 참고하거나 사용하여 발생하는 모든 결과(장비 손상, 생물 피해, 화재, 감전 등)에 대한 책임은 전적으로 사용자 본인에게 있습니다. 자신의 판단과 책임 하에 사용하시기 바랍니다.
