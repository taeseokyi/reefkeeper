...
and room-\co{} excursions are common-mode signals that cancel. Over an
nine-day instrumented campaign (28 logged measurements across five
...
Eq.~\eqref{eq:dkh}). (Firmware retains legacy solenoid-era pin names from an
earlier hardware revision; pin behaviour is as described.)
...
\begin{table}[p]
\centering
\caption{Complete measurement campaign (28 runs). ``abs pH'' is the common-mode
...
PN = partial null, CN = complete null.}
\label{tab:data}
\scriptsize
\setlength{\tabcolsep}{4pt}
\begin{tabular}{@{}r l l r r r r r p{0.30\linewidth}@{}}
\toprule
...
27& 06-21 19:00 & V4+S,CN& 7.960 & 7.957 & $-0.003$ & 8.387 & 27.4 & \textbf{complete null}: both = ref water; raw err $-0.061$ = pure instrument offset; 100\,mL vs.\ 5\,L cancels \\
28& 06-22 09:00 & V4+S,CN& 7.959 & 7.948 & $-0.011$ & 8.226 & 27.4 & \textbf{aged complete null} ($\sim$14\,h, $100\,\mathrm{mL}$ exposed aliquot): null decayed to raw err $-0.22$; tank true plateau 59$\times$ (long aeration drives precipitation) \\
\bottomrule
\end{tabular}
\end{table}
...
(Fig.~\ref{fig:degrade}, run \#28). The raw error---$-0.061$ and $-0.014\dkh$ at
...
\#1115439; UltimateReef \#939234; Bay Area Reefers \#40433. (Sources recorded as
forum thread identifiers; quotations are translations of community/manufacturer
posts and should be verified against the originals before formal publication.)
\end{thebibliography}
